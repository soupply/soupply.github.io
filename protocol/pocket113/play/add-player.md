...
[home](/)  /  [pocket113](/protocol/pocket113)  /  [play](/protocol/pocket113/play)  /  add-player

# Add player

Encode/decode this packet in [Sandbox](../../../sandbox/pocket113#play.add_player)
...
head yaw | float
yaw | float
held item | [slot](/protocol/pocket113/types/slot)
