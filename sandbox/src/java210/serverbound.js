const Serverbound ={
	...
	PlayerBlockPlacement: class extends Packet{
		...
		encodeBody(reset){
			...
			this.writeVaruint(this.hand);
			this.writeByte(this.cursorPosition.x);
			this.writeByte(this.cursorPosition.y);
			this.writeByte(this.cursorPosition.z);
			return new Uint8Array(this._buffer);
		}
		...
		decodeBody(_buffer){
			...
			traceDecode('hand');
			this.cursorPosition={};
			this.cursorPosition.x=this.readByte();
			this.cursorPosition.y=this.readByte();
			this.cursorPosition.z=this.readByte();
