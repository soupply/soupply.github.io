const Play ={
	...
	Login: class extends Buffer{
		...
		constructor(protocol=113,version=0,body=new Types.LoginBody()){
			super();
	...
	AddPlayer: class extends Buffer{
		...
		constructor(uuid=new Types.McpeUuid(),username="",entityId=0,runtimeId=0,position={x:0,y:0,z:0},motion={x:0,y:0,z:0},pitch=.0,headYaw=.0,yaw=.0,heldItem=new Types.Slot(),metadata=new Metadata()){
			super();
			this.uuid = uuid;
	...
	InventoryAction: class extends Buffer{
		...
		constructor(action=0,item=new Types.Slot(),unknown2=0,unknown3=0){
			super();
			this.action = action;
			this.item = item;
			this.unknown2 = unknown2;
	...
	ContainerSetContent: class extends Buffer{
		...
		constructor(window=0,entityId=0,slots=[],hotbar=new Int32Array(0)){
			super();
			this.window = window;
			this.entityId = entityId;
			this.slots = slots;
