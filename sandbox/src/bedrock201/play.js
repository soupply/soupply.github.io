 ...
 */
// module soupply.bedrock201.play;
...
const Play = {
	...
	Login: class extends Buffer {
		...
		constructor(protocol=201, body=null) {
			super();
	...
	StartGame: class extends Buffer {
		...
		encode() {
			...
			this.writeVarint(this.default_permission_level);
			this.writeVarint(this.xbox_live_broadcast_mode);
			this.writeLittleEndianInt(this.server_chunk_tick_radius);
			...
			this.writeVarint(this.enchantment_seed);
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			this.default_permission_level=this.readVarint();
			this.xbox_live_broadcast_mode=this.readVarint();
			this.server_chunk_tick_radius=this.readLittleEndianInt();
			...
			this.enchantment_seed=this.readVarint();
			return this;
		}
	...
	CommandRequest: class extends Buffer {
		...
		constructor(command="", type=0, uuid=null, requestId="", playerId=0, internal=false) {
			super();
		...
		/** @return {string} */
		toString() {
			return "CommandRequest(command: " + this.command + ", type: " + this.type + ", uuid: " + this.uuid + ", request_id: " + this.request_id + ", player_id: " + this.player_id + ", internal: " + this.internal + ")";
		}
