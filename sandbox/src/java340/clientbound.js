 ...
 */
// module soupply.java340.clientbound;
...
const Clientbound = {
	...
	UpdateBlockEntity: class extends Buffer {
		...
		static get BED_COLOR(){ return 11; };
	...
	CraftRecipeResponse: class extends Buffer {
		...
		/** @param {(Uint8Array|Array)} buffer */
		static fromBuffer(buffer) {
			return new Clientbound.CraftRecipeResponse().decode(buffer);
		}
	...
	UnlockRecipes: class extends Buffer {
		...
		constructor(action=0, openBook=false, filtering=false, recipes=[], bookRecipes=[]) {
			super();
			this.action = action;
		...
		encode() {
			...
			if(action==1||action==3) {
				this.writeVaruint(this.book_recipes.length);
				for(var dhc5b9xj in this.book_recipes) {
					this.writeVaruint(this.book_recipes[dhc5b9xj]);
				}
			}
			return new Uint8Array(this._buffer);
		}
		...
		decode(_buffer) {
			...
			if(action==1||action==3) {
				var aramy9a9=this.readVaruint();
				this.book_recipes=[];
				for(var dhc5b9xj=0;dhc5b9xj<aramy9a9;dhc5b9xj++) {
					this.book_recipes[dhc5b9xj]=this.readVaruint();
				}
			}
			return this;
		}
		...
		/** @param {(Uint8Array|Array)} buffer */
		static fromBuffer(buffer) {
			return new Clientbound.UnlockRecipes().decode(buffer);
		}

		/** @return {string} */
		toString() {
			return "UnlockRecipes(action: " + this.action + ", open_book: " + this.open_book + ", filtering: " + this.filtering + ", recipes: " + this.recipes + ", book_recipes: " + this.book_recipes + ")";
		}
	...
	AdvancementProgress: class extends Buffer {
		...
		/** @param {(Uint8Array|Array)} buffer */
		static fromBuffer(buffer) {
			return new Clientbound.AdvancementProgress().decode(buffer);
		}

		/** @return {string} */
		toString() {
			return "AdvancementProgress(not_empty: " + this.not_empty + ", identifier: " + this.identifier + ")";
		}
	...
	Advencements: class extends Buffer {
		...
		/** @param {(Uint8Array|Array)} buffer */
		static fromBuffer(buffer) {
			return new Clientbound.Advencements().decode(buffer);
		}
