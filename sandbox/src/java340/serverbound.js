 ...
 */
// module soupply.java340.serverbound;
...
const Serverbound = {
	...
	CraftRecipeRequest: class extends Buffer {
		...
		decode(_buffer) {
			...
			this.make_all=this.readBool();
			return this;
		}

		/** @param {(Uint8Array|Array)} buffer */
		static fromBuffer(buffer) {
			return new Serverbound.CraftRecipeRequest().decode(buffer);
		}

		/** @return {string} */
		toString() {
			return "CraftRecipeRequest(window: " + this.window + ", recipe: " + this.recipe + ", make_all: " + this.make_all + ")";
		}
